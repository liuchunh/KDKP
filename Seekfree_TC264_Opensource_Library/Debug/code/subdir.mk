...
clean-code:
	-$(RM) ./code/fusion_task.d ./code/fusion_task.o ./code/fusion_task.src ./code/imu_task.d ./code/imu_task.o ./code/imu_task.src ./code/kalman_filter.d ./code/kalman_filter.o ./code/kalman_filter.src ./code/nav_controller.d ./code/nav_controller.o ./code/nav_controller.src ./code/pid_controller.d ./code/pid_controller.o ./code/pid_controller.src ./code/uart_utils.d ./code/uart_utils.o ./code/uart_utils.src
