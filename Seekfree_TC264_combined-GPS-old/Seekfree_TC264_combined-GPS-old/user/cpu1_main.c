...
static void display_update(void)
{
    ...
    ips200_show_float(40, 48, gnss.latitude, 3, 6);

    ips200_show_string(0, 72, "LON :");
    ips200_show_string(40, 72, "                ");
    ips200_show_float(40, 72, gnss.longitude, 3, 6);
    ...
    if(gnss.state)
    {
        ips200_show_string(40, 168, "FIX SAT:");
        ips200_show_uint(96, 168, gnss.satellite_used, 2);
    }
    else if(gnss_rx_byte_count > 0)
    {
        ips200_show_string(40, 168, "RX NO FIX");
    }
    else
    {
        ips200_show_string(40, 168, "NO SIGNAL");
    }
}
