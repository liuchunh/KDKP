...
void dot_matrix_screen_show_pattern     (uint8 index);//新增
void dot_matrix_screen_clear_pattern    (void);//新增
typedef enum
{
    DOT_MATRIX_PATTERN_DOUBLE_FLASH = 0,   // 双闪
    DOT_MATRIX_PATTERN_TURN_LEFT,          // 左转
    DOT_MATRIX_PATTERN_TURN_RIGHT,         // 右转
    DOT_MATRIX_PATTERN_LOW_BEAM,           // 近光
    DOT_MATRIX_PATTERN_HIGH_BEAM,          // 远光
    DOT_MATRIX_PATTERN_FOG_LIGHT,          // 雾灯
    DOT_MATRIX_PATTERN_MAX
} dot_matrix_pattern_t;

// 图模显示接口（内部通过扫描函数发送到 TLD7002）
