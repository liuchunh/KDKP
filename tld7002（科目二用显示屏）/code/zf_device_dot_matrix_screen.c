...
// ================= 1. 双闪 (Double Flash) =================
const uint8_t LED_DoubleFlash_Left[7]  = {0x20, 0x30, 0x38, 0x3C, 0x38, 0x30, 0x20};
const uint8_t LED_DoubleFlash_Mid[7]   = {0x00, 0x00, 0x08, 0x08, 0x08, 0x00, 0x00};
const uint8_t LED_DoubleFlash_Right[7] = {0x02, 0x06, 0x0E, 0x1E, 0x0E, 0x06, 0x02};

// ================= 2. 左转 (Turn Left) =================
const uint8_t LED_TurnLeft_Left[7]  = {0x20, 0x30, 0x38, 0x3C, 0x38, 0x30, 0x20};
const uint8_t LED_TurnLeft_Mid[7]   = {0x00, 0x00, 0x3E, 0x3E, 0x3E, 0x00, 0x00};
const uint8_t LED_TurnLeft_Right[7] = {0x00, 0x00, 0x1E, 0x1E, 0x1E, 0x00, 0x00};

// ================= 3. 右转 (Turn Right) =================
const uint8_t LED_TurnRight_Left[7]  = {0x00, 0x00, 0x3C, 0x3C, 0x3C, 0x00, 0x00};
const uint8_t LED_TurnRight_Mid[7]   = {0x00, 0x00, 0x3E, 0x3E, 0x3E, 0x00, 0x00};
const uint8_t LED_TurnRight_Right[7] = {0x02, 0x06, 0x0E, 0x1E, 0x0E, 0x06, 0x02};

// ================= 4. 近光灯 (Low Beam) =================
const uint8_t LED_LowBeam_Left[7]  = {0x20, 0x10, 0x08, 0x08, 0x08, 0x10, 0x20};
const uint8_t LED_LowBeam_Mid[7]   = {0x3E, 0x20, 0x20, 0x20, 0x20, 0x20, 0x3E};
const uint8_t LED_LowBeam_Right[7] = {0x04, 0x08, 0x14, 0x08, 0x14, 0x08, 0x10};

// ================= 5. 远光灯 (High Beam) =================
const uint8_t LED_HighBeam_Left[7]  = {0x20, 0x10, 0x08, 0x08, 0x08, 0x10, 0x20};
const uint8_t LED_HighBeam_Mid[7]   = {0x3E, 0x20, 0x20, 0x20, 0x20, 0x20, 0x3E};
const uint8_t LED_HighBeam_Right[7] = {0x00, 0x1C, 0x00, 0x1C, 0x00, 0x1C, 0x00};

// ================= 6. 雾灯 (Fog Light) =================
const uint8_t LED_Fog_Left[7]  = {0x20, 0x10, 0x08, 0x08, 0x08, 0x10, 0x20};
const uint8_t LED_Fog_Mid[7]   = {0x3E, 0x20, 0x20, 0x20, 0x20, 0x20, 0x3E};
const uint8_t LED_Fog_Right[7] = {0x08, 0x1C, 0x08, 0x1C, 0x08, 0x1C, 0x08};
