...
volatile uint32 sync_isr_count = 0;     // SYNC �ж���ϼ�����
...
IFX_INTERRUPT(exti_ch3_ch7_isr, 0, EXTI_CH3_CH7_INT_PRIO)
{
    ...
    if(exti_flag_get(ERU_CH7_REQ11_P20_9))          // ͨ��7�ж�
    {
        exti_flag_clear(ERU_CH7_REQ11_P20_9);
        dot_matrix_screen_scan();                   // ������ɨ��ˢ��
        sync_isr_count++;                           // ��ϼ���
    }
}
// **************************** �ⲿ�жϺ��� ****************************
...
{
    interrupt_global_enable(0);                     // �����ж�Ƕ��
    debug_interrupr_handler();                      // debug串口接收
    screen_uart_rx_handler();                      // ��ȡ�����ֽ�д�� screen FIFO
}
