...
static soft_iic_info_struct *mt9v03x_iic_obj  = NULL;
static soft_iic_info_struct *scc8660_iic_obj   = NULL;

//-------------------------------------------------------------------------------------------------------------------
// mt9v03x config via SCCB
//-------------------------------------------------------------------------------------------------------------------
unsigned char mt9v03x_set_config_sccb (void *soft_iic_obj, short int buff[10][2])
{
    mt9v03x_iic_obj = (soft_iic_info_struct *)soft_iic_obj;
    mt9v03x_iic_obj->addr = MT9V03X_SCCB_ADDR;

    for(uint32 i = 1; i < 10; i++)
    {
        soft_iic_sccb_write_register(mt9v03x_iic_obj, 0xFE, (uint8)(buff[i][0] >> 8));
        soft_iic_sccb_write_register(mt9v03x_iic_obj, 0xFE, (uint8)(buff[i][0] & 0xFF));
        soft_iic_sccb_write_register(mt9v03x_iic_obj, 0xFF, (uint8)(buff[i][1] >> 8));
        soft_iic_sccb_write_register(mt9v03x_iic_obj, 0xFF, (uint8)(buff[i][1] & 0xFF));
    }
    return 0;
}
...
{
    soft_iic_sccb_write_register(mt9v03x_iic_obj, 0xFE, 0x00);
    soft_iic_sccb_write_register(mt9v03x_iic_obj, 0xFE, 0xF0);
    soft_iic_sccb_write_register(mt9v03x_iic_obj, 0xFF, (uint8)(light >> 8));
    soft_iic_sccb_write_register(mt9v03x_iic_obj, 0xFF, (uint8)(light & 0xFF));
    return 0;
}
...
{
    soft_iic_sccb_write_register(mt9v03x_iic_obj, 0xFE, 0x00);
    soft_iic_sccb_write_register(mt9v03x_iic_obj, 0xFE, addr);
    soft_iic_sccb_write_register(mt9v03x_iic_obj, 0xFF, (uint8)(data >> 8));
    soft_iic_sccb_write_register(mt9v03x_iic_obj, 0xFF, (uint8)(data & 0xFF));
    return 0;
}
