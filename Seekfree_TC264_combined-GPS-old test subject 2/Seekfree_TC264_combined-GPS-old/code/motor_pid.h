...
#include "encoder.h"            /* 使用 encoder.h 中的 ENCODER_PPR 等定义 */
...
#define GEAR_RATIO        1.655f  /* 减速比: 编码器转N圈，轮子转1圈 */
#define EFFECTIVE_PPR     (ENCODER_PPR * GEAR_RATIO)     /* ENCODER_PPR 来自 encoder.h */
