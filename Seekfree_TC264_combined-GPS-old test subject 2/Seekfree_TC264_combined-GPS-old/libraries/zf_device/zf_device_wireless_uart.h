...
//================================================定义 无线串口 基本配置===================================================
#define WIRELESS_UART_INDEX         (UART_3)                                    // 无线串口对应使用的串口号
#define WIRELESS_UART_BUAD_RATE     (115200)                                    // 无线串口对应使用的串口波特率
#define WIRELESS_UART_TX_PIN        (UART3_RX_P15_7)                            // 无线串口对应模块的 TX 要接到单片机的 RX
#define WIRELESS_UART_RX_PIN        (UART3_TX_P15_6)                            // 无线串口对应模块的 RX 要接到单片机的 TX
