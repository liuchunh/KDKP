 ...
 * 项目定位：基于[TC264DA核心技术/依赖]的核心功能演示 - 正交编码器测试例程
 ...
 * -------------------------------------------
 * 2025年12月25日      毛毛    V3.0     
 * 2026年01月10日      毛毛    V3.1     增加 3路 正交编码器测试
 *
 * === 实验现象 ===
 * 1. 编码器 1 (TIM6): 
 *    - A相: P20.3
...
void core0_main(void)
{
    ...
    // 初始化正交编码器 1 (TIM6)
    // A相=P20.3, B相=P20.0
    encoder_init_quad(ENCODER_TIM6, TIM6_ENC_A_P20_3, TIM6_ENC_B_P20_0);

    // 初始化正交编码器 2 (TIM2)
    // A相=P33.7, B相=P33.6
    encoder_init_quad(ENCODER_TIM2, TIM2_ENC_A_P33_7, TIM2_ENC_B_P33_6);

    // 初始化正交编码器 3 (TIM4)
    // A相=P02.8, B相=P00.9
    encoder_init_quad(ENCODER_TIM4, TIM4_ENC_A_P02_8, TIM4_ENC_B_P00_9);
    ...
    while(1)
    {
        ...
        // IPS显示
        ips_show_string(10, 20, "Quad Encoder Test");
