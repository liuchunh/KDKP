...
"code/motor.o":"code/motor.src" "code/subdir.mk"
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
"code/motor_encoder_test.src":"../code/motor_encoder_test.c" "code/subdir.mk"
	cctc -cs --dep-file="$*.d" --misrac-version=2012 -D__CPU__=tc26xb "-fD:/ADS/KDKP/imu/Seekfree_TC264_Opensource_Library/Seekfree_TC264_Opensource_Library/Debug/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc26xb -Y0 -N0 -Z0 -o "$@" "$<"
"code/motor_encoder_test.o":"code/motor_encoder_test.src" "code/subdir.mk"
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
...
clean-code:
	-$(RM) ./code/encoder.d ./code/encoder.o ./code/encoder.src ./code/fusion_task.d ./code/fusion_task.o ./code/fusion_task.src ./code/imu_task.d ./code/imu_task.o ./code/imu_task.src ./code/kalman_filter.d ./code/kalman_filter.o ./code/kalman_filter.src ./code/motor.d ./code/motor.o ./code/motor.src ./code/motor_encoder_test.d ./code/motor_encoder_test.o ./code/motor_encoder_test.src ./code/nav_controller.d ./code/nav_controller.o ./code/nav_controller.src ./code/pid_controller.d ./code/pid_controller.o ./code/pid_controller.src ./code/uart_utils.d ./code/uart_utils.o ./code/uart_utils.src
